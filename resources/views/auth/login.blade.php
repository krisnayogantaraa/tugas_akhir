    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-26 h-24 mr-10" src="{{ asset('storage/img/ciko_ok.png') }}" alt="logo">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        @error('email')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-2 py-2 rounded relative mt-4" role="alert">
                            <strong class="font-bold text-sm">Email/Password Salah!</strong>
                        </div>
                        @enderror
                    ...
                    <a href="{{ route('welcome') }}" class="text-green-500 hover:underline mt-2 block">Go to Welcome</a>
